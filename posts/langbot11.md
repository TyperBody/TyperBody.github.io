...
![Dify 工作流开始节点配置](/images/dify_workflow_var.png)
...
![Dify 应用 API 密钥](/images/dify_sv_api_01.png)
...
![设置开发项](/images/dify_sv_api_02.png)

<Info title="### 工作流输出键">

如果使用的是 Dify 的工作流应用，那么请使用 `summary` 作为键传递输出内容。

![Dify 工作流应用的输出键](/images/dify_workflow_output_key.png)
...
![n8n 作为运行器](/images/config_runner.png)
...
![n8n 工作流](/images/create_wf.png)
or 
![n8n 工作流](/images/create_wf01.png)

需要选择`Webhook`或者`On chat message`触发，并参考下图配置：
* webhook
    ![n8n webhook 配置](/images/config_webhook.png)
* on chat message
    ![n8n on chat message 配置](/images/config_n8n_onchatmessage.png)

<Info title="如果要需要流式，其中的`Response Mode`都需要选择为`Streaming`。">
![n8n 流式配置](/images/config_response_model.png)
</Info>


<Info title="Authentication 对应 LangBot 流水线配置中的几种鉴权方式，可自行更改。">

![n8n 工作流配置](/images/config_auth.png)
</Info>
...
![TBox API Key](/images/create_api_key.png)

并在 TBox 的智能体编排页面找到该应用的 AppID：

![TBox AppID](/images/find_appid.png)

接着回到 LangBot 流水线设置中，切到`AI 能力`配置页面，选择`蚂蚁百宝箱平台 API` 作为运行器：

![TBox API Key](/images/tbox_runner.png)
...
![Coze 应用 API 密钥](/images/coze07.png)
2. 在"API 管理"中创建并复制令牌。
![Coze 应用 API 密钥](/images/coze06.png)
...
![Coze bot_id](/images/coze05.png)
* 智能体发布一定要选上api的选项
![Coze 应用 API 密钥](/images/coze04.png)
